	...
	root: ({
		commonCore: {
			...
			share: {
				...
				firstSaveA1bis: "The application can also be found in your <a href='%LINK2%' target='_blank'>%PORTAL% content folder</a>.",
				...
				shareQ2bis: "How do I get back to the builder interface?",
