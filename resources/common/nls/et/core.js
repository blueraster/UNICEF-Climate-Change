	 ...
	 ({
		commonCore: {
			...
			share: {
				...
				sharePrivateWarning: "Jagamine %WITH% on keelatud, sest te pole <a href='%LINK%' target='_blank'>veebikaardi</a> omanik.",
				sharePrivateWarningWith1: "avalikult",
				sharePrivateWarningWith2: "avalikult ja organisatsiooniga",
				sharePrivateProgress: "Jagamist teostatakse...",
				sharePrivateErr: "Jagamine nurjus. Proovige uuesti või",
				sharePrivateOk: "Jagamine uuendati edukalt, laadin...",
				...
				shareQ3: "Kus on andmed talletatud?",
				shareA3: "Malli %TPL_NAME% andmed ja konfiguratsioon salvestatakse <a href='%LINK2%' target='_blank'>selles veebirakenduses üksuses</a>. Kui olete kasutanud rakenduste Flickr, Picasa, Facebook või YouTube importi, siis Teie pilte ja videoid ei ole kopeeritud lehel %PORTAL%."
			},
			settings: {
				header: "Seaded",
