	 ...
	 ({
		commonCore: {
			...
			builderPanel: {
				...
				shareStatus1: "Aplicaţia nu a fost salvată încă",
			...
			share: {
				...
				firstSaveA1bis: "De asemenea, aplicaţia poate fi găsită în <a href='%LINK2%' target='_blank'>directorul de conţinut al %PORTAL%</a>.",
				...
				shareQ2bis: "Cum revin la interfaţa builderului?",
