	 ...
	 ({
		commonCore: {
			...
			builderPanel: {
				...
				shareStatus1: "لم يتم حفظ التطبيق بعد",
			...
			share: {
				...
				firstSaveA1bis: "يمكن أيضًا إيجاد التطبيق في <a href='%LINK2%' target='_blank'>%PORTAL%مجلد المحتويات</a>.",
				...
				shareQ2bis: "كيف يمكن الرجوع إلى واجهة عرض المُنشئ؟",
